...
(function() {
  var game, leftEmitter, rightEmitter;
  ...
  game = new Phaser.Game({
    ...
    state: {
      ...
      create: function() {
        ...
        leftEmitter = this.add.emitter(50, game.world.centerY - 200);
        leftEmitter.bounce.setTo(0.5, 0.5);
        leftEmitter.setXSpeed(100, 200);
        leftEmitter.setYSpeed(-50, 50);
        leftEmitter.makeParticles('balls', 0, 250, true, true);
        rightEmitter = this.add.emitter(game.world.width - 50, game.world.centerY - 200);
